<doc>
    ...
    <code>npm install my-vue-doc -g</code>
    ...
    <li>文档目录——src/pages</li>
    <li>例子目录——src/demo</li>
    <li>全局配置——app.json</li>
    <li>主题配置——theme.less</li>
    <li>应用程序入口——app.js</li>
    ...
    <h3>全局配置</h3>
    <p><span>/src/app.json</span>是框架的主配置文件，配置如文档库名称、版本等功能，具体请参考<a href="laden666666.github.io/my-vue-doc#/appConfig"></a>。</p>

    <h3>应用程序入口</h3>
    <p><span>/src/app.js</span>是框架的入口文件，配置如文档库名称、版本等功能，具体请参考<a href="laden666666.github.io/my-vue-doc#/appConfig"></a>。</p>
